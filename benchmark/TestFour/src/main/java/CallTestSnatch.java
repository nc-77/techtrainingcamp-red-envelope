...
public class CallTestSnatch implements Runnable{
    private static Logger log = Logger.getLogger(CallTestSnatch.class);
    ...
    CallTestSnatch(String i, CountDownLatch begin, CountDownLatch end){
        this.id = i;
        this.begin = begin;
        this.end = end;
    }
